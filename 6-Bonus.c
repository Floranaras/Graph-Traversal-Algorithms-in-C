...
/*
    ...
    Post-condition:
    - file will be updated with the vertices of the second graph and their statuses of being included in the first graph
*/
...
/*
    Purpose: Checks if an edge exists in graph G and returns the appropriate status symbol
...
/*
    ...
    - graphG and graphH must be initialized prior to calling this function
    Post-condition:
    - file will be updated with the edges of the second graph and their statuses of being included in the first graph
*/
...
/*
    Purpose: To check if all vertices in graph H exist in graph G
    Returns: 1 if all vertices exist, 0 otherwise
    ...
    Post-condition:
    - 1 will be returned if all vertices in graph H exist in graph G
    - 0 will be returned if one or more vertices in graph H don't exist in graph G
*/
...
/*
    ...
    Post-condition:
    - 1 will be returned if no edge exists between vertices at nHIndex1 and nHIndex2 in graph H or if the edge exists in both graphs
...
/*
    ...
    Returns: void
    @param pFile The pointer to a file
    ...
    Post-condition:
    - pFile will be updated with the conclusion of the first graph being or not being a subgraph of the second graph
*/
...
/*
    ...
    - pGraphG and pGraphH must be initialized prior to calling this function
    Post-condition:
    - the output file is created with the corresponding details about the vertices, edges, statuses, and conclusion
*/
...
/*
	...
	@param strFileH The file name of the second graph with file extension 
	Pre-condition: - none
	Post-condition: - strFileG and strFileH contain the file names of graphs G and H respectively
*/

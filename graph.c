...
/*
	Purpose: Initialize the adjacency representations of the graph data
...
/*
	Purpose: Reads information from input file and add to the graph data
   structure Returns: 1 indicating a successful read, 0 otherwise
	@param strInputFileName: String of the input file name to read the graph
   information from
	@param graph: Struct for graph data structure
	Pre-condition:
...
/*
	Purpose: Sorts the index of the vertices in the graph by value of the label
   of each node into idx Returns: void
	@param graph: Struct for graph data structure
...
*/
void printVertexAdjacencyList(FILE *fp, String50 vertex, String50 adjVertices[],
							  int adjCount) 
{
	int j;
...
/*
	Purpose: To create/write an output file that lists a graph's vertices and
   their degrees Returns: void
	...
	Post-condition:
	- the output file is created with the details about the vertices and their
   degrees
*/
...
/*
	...
	- baseName must contain at least one character
	Post-condition:
	- the output file is created with a representation of the adjacency list of
   a graph
*/
...
/*
	...
	- baseName must contain at least one character
	Post-condition:
	- the output file is created with a representation of the adjacency matrix
   of a graph
*/
...

{
	...
	while (frontOfQueue < tailofQueue) 
	{
		...
		for (i = 0; i < candidatesCtr - 1; i++) 
		{
			...
			{
				if (strcmp(graph->vertices[candidates[j]],
			   graph->vertices[candidates[minIdx]]) < 0) 
				{
					minIdx = j;
				}
			}
...
/*
	...
	- result[] contains the vertices in the order they were visited
*/
void DFS (graphType *graph, int previousIndex, String50 result[], 
		  int visited[], int *resultsCtr) 
{
	int i, minIdx, temp, j;
	int candidates[MAX_VERTICES];
	int candidateCtr = 0;
